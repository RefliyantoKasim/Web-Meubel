                    ...
                    <div class="col-12 col-md-12 col-lg-5">
                        <div class="card profile-widget">
                            ...
                            <div class="card-footer text-center">
                                <div class="font-weight-bold mb-2">Follow Refli On</div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control" value="Refli" required="">
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control" value="Kasim" required="">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-7 col-12">
                                            ...
                                            <input type="email" class="form-control"
                                                value={{ Auth::user()->role === 'staf' ? 'Staff' : Auth::user()->email }}
                                                required="">
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-5 col-12">
                                            ...
                                            <input type="tel" class="form-control"
                                                value=" {{ Auth::user()->role === 'staf' ? 'Staff' : Auth::user()->phone }}">
                                        </div>
                                    </div>
                                    <div class="row">
