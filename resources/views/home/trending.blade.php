            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('trending') }}">Kontak</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="thumb">
                                ...
                                <div class="hover-effect">
                                    <div class="inner-content">
                                        <a href="explore.html">
                                            <h4>Minimal Design Interior</h4>
                                        </a>
                                        <a class="icon" href="explore.html"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="trending-item">
                            <div class="thumb">
                                ...
                                <div class="hover-effect">
                                    <div class="inner-content">
                                        <a href="explore.html">
                                            <h4>Minimal Bungalow Interior</h4>
                                        </a>
                                        <a class="icon" href="explore.html"><svg xmlns="http://www.w3.org/2000/svg"
                                                width="28" height="28" fill="currentColor"
                                                class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                        ...
                        <div class="trending-item">
                            <div class="thumb">
                                ...
                                <div class="hover-effect">
                                    <div class="inner-content">
                                        <a href="explore.html">
                                            <h4>Minimal Bedroom Interior</h4>
                                        </a>
                                        <a class="icon" href="explore.html"><svg xmlns="http://www.w3.org/2000/svg"
                                                width="28" height="28" fill="currentColor"
                                                class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                        ...
                        <div class="trending-item">
                            <div class="thumb">
                                ...
                                <div class="hover-effect">
                                    <div class="inner-content">
                                        <a href="explore.html">
                                            <h4>Specific Design Interior</h4>
                                        </a>
                                        <a class="icon" href="explore.html"><svg xmlns="http://www.w3.org/2000/svg"
                                                width="28" height="28" fill="currentColor"
                                                class="bi bi-arrow-right-short" viewBox="0 0 16 16">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="about-widget">
                        ...
                        <p>Designer is free Bootstrap v5.1.3 HTML CSS template. Everyone can download the best free CSS
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <p>Copyright © 2022 Designer Co., Ltd. All Rights Reserved.
                                    ...
                                    <br>Design: <a rel="sponsored" href="https://templatemo.com/page/1"
