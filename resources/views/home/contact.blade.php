                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                enable-background="new 0 0 24 24" height="44" viewBox="0 0 24 24"
                                                width="44">
                                                <g>
                                    ...
                                    <li>
                                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                enable-background="new 0 0 24 24" height="48" viewBox="0 0 24 24"
                                                width="48">
                                                <g>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="about-widget">
                        ...
                        <p>Designer is free Bootstrap v5.1.3 HTML CSS layout for your website. Everyone can download
                            best HTML CSS templates from TemplateMo website instantly.</p>
                    </div>
                </div>
